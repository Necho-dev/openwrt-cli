...
_DEVICE_CMDS = (
    ...
    ["network", "leases"],
    ["network", "neighbors"],
    ["network", "set-hostname", "--mac", "aa:bb:cc:dd:ee:ff", "--name", "x", "--yes"],
    ["network", "metrics"],
    ["network", "stats"],
    ["network", "traffic"],
    ["network", "wifi", "list"],
    ...
    ["passwall2", "acl"],
    ["passwall2", "acl", "show", "cfgacl1"],
    ["passwall2", "acl", "log", "cfgacl1", "--tail", "5", "--since", "10m"],
    ["passwall2", "node", "show", "cfghk1"],
    ["passwall2", "node", "ping", "cfghk1"],
    ["passwall2", "components", "check"],
    ["passwall2", "logs", "--tail", "5", "--since", "10m"],
    ["backup", "list"],
    ["backup", "create"],
)
